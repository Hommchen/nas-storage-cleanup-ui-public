...
const _hoisted_14 = { class: "resource-card" };
const _hoisted_15 = { class: "table-head" };
const _hoisted_16 = {
  key: 0,
  class: "empty-state"
};
const _hoisted_17 = ["disabled", "onClick"];
const _hoisted_18 = { class: "resource-title" };
const _hoisted_19 = {
...
const _hoisted_27 = { class: "action-buttons" };
...
const _hoisted_33 = { class: "plan-resources" };
const _hoisted_34 = {
  key: 0,
  class: "plan-state"
};
...
const _hoisted_41 = { class: "safety-note" };
const _hoisted_42 = {
  key: 3,
...
const _hoisted_49 = { class: "modal compact-modal" };
const _hoisted_50 = {
  key: 0,
  class: "empty-state"
};
...
const _hoisted_52 = { class: "modal compact-modal" };
const _hoisted_53 = {
  key: 0,
  class: "empty-state"
};
...
return (_ctx, _cache) => {
  return (_openBlock(), _createElementBlock("main", _hoisted_1, [
    ...
    (onboardingRequired.value)
      ? (_openBlock(), _createElementBlock("section", _hoisted_9, [
          _createElementVNode("div", null, [
            ...
            (error.value)
              ? (_openBlock(), _createElementBlock("span", _hoisted_10, _toDisplayString(error.value), 1))
              : (_openBlock(), _createElementBlock("span", _hoisted_11, "请由 NAS 管理员先部署 PiNAS 清理台，并完成只读路径探测；插件不会自动登录或配置 NAS。"))
          ]),
          _createElementVNode("button", {
            type: "button",
            onClick: openSettings
    ...
    _createElementVNode("section", _hoisted_14, [
      ...
      (loading.value)
        ? (_openBlock(), _createElementBlock("div", _hoisted_16, "正在读取真实资源关系…"))
        : (_openBlock(true), _createElementBlock(_Fragment, { key: 1 }, _renderList(visible.value, (item) => {
            return (_openBlock(), _createElementBlock("article", {
              ...
              }, _toDisplayString(item.protected ? '锁' : selected.value.includes(item.id) ? '✓' : ''), 11, _hoisted_17),
              ...
              _createElementVNode("div", _hoisted_19, [
                ...
                (item.episodeStatus === 'incomplete')
                  ? (_openBlock(), _createElementBlock("span", _hoisted_20, " 缺 " + _toDisplayString(item.episodeMissing) + " 集 · 已有 " + _toDisplayString(item.episodeActual) + " / 应有 " + _toDisplayString(item.episodeExpected), 1))
                  : _createCommentVNode("", true)
              ]),
      ...
      (!loading.value && !visible.value.length)
        ? (_openBlock(), _createElementBlock("div", _hoisted_24, " 没有符合条件的资源，请取消筛选或更换关键词。 "))
        : _createCommentVNode("", true)
    ]),
    (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
      (selected.value.length)
        ? (_openBlock(), _createElementBlock("aside", _hoisted_25, [
            _createElementVNode("div", _hoisted_26, _toDisplayString(selected.value.length), 1),
            _createElementVNode("p", null, [
            ...
            _createElementVNode("section", _hoisted_29, [
              ...
              _createElementVNode("div", {
                ...
                (plan.value && planMode.value === 'delete')
                  ? (_openBlock(), _createElementBlock("strong", _hoisted_31, "已核算可释放 " + _toDisplayString(_unref(formatBytes)(plan.value.estimatedReclaimBytes)), 1))
                  : (_openBlock(), _createElementBlock("strong", _hoisted_32, _toDisplayString(currentAction.value?.detail), 1)),
              ...
              (planLoading.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_34, "正在刷新 NAS 状态并复核关系…"))
                : (planError.value)
                  ...
                  : (plan.value)
                    ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                        ...
                        (plan.value.requiresSiteAcknowledgement)
                          ? (_openBlock(), _createElementBlock("label", _hoisted_38, [
                          ...
                          : _createCommentVNode("", true),
                        (planExpired.value)
                          ? (_openBlock(), _createElementBlock("div", _hoisted_40, [...(_cache[31] || (_cache[31] = [
              ...
              _createElementVNode("div", _hoisted_41, [
                ...
                _createElementVNode("p", null, [
                  ...
                  _cache[32] || (_cache[32] = _createElementVNode("span", null, "最终执行前复核当前清单，执行器只回读所选资源的 qB、路径和硬链接。", -1))
                ])
              ]),
              (executeResult.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_42, [
                    ...
                    (executeResult.value.snapshotRefreshPending)
                      ? (_openBlock(), _createElementBlock("span", _hoisted_43, _toDisplayString(planMode.value === 'delete' ? '已从当前列表移除，请刷新资源清单后继续操作。' : '操作已完成，请刷新资源清单后继续操作。'), 1))
                      : _createCommentVNode("", true),
                    _createElementVNode("button", {
                      type: "button",
                      onClick: closePlan
                ...
                : (finalConfirmation.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_44, [
                      ...
                      (executeError.value)
                        ? (_openBlock(), _createElementBlock("span", _hoisted_45, _toDisplayString(executeError.value), 1))
                        : _createCommentVNode("", true),
                      _createElementVNode("div", null, [
                        _createElementVNode("button", {
                          type: "button",
                        ...
                        _createElementVNode("button", {
                          ...
                          onClick: executePlan
                        }, _toDisplayString(executing.value ? '正在定向复核…' : `确认${currentAction.value?.title}`), 11, _hoisted_47)
                      ])
                    ]))
                  : (_openBlock(), _createElementBlock("button", {
                      key: 5,
      ...
      (gapOpen.value)
        ? (_openBlock(), _createElementBlock("div", {
            ...
            _createElementVNode("section", _hoisted_49, [
              ...
              (gapLoading.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_50, "正在核对…"))
                : _createCommentVNode("", true),
              (gapError.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_51, _toDisplayString(gapError.value), 1))
                : _createCommentVNode("", true),
        ...
        ? (_openBlock(), _createElementBlock("div", {
            ...
            _createElementVNode("section", _hoisted_52, [
              ...
              (recoveryLoading.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_53, "正在读取事务…"))
                : _createCommentVNode("", true),
              (recoveryError.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_54, _toDisplayString(recoveryError.value), 1))
                : _createCommentVNode("", true),
              ...
              (recoveryTarget.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_57, [
                    ...
                    _createElementVNode("button", {
                      ...
                      onClick: runRecovery
                    }, _toDisplayString(recovering.value ? '处理中…' : '执行恢复'), 9, _hoisted_58)
                  ]))
                : _createCommentVNode("", true)
            ])
          ]))
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-08a481fe"]]);

...
const _hoisted_15 = { class: "resource-card" };
...
const _hoisted_19 = { class: "resource-title" };
const _hoisted_20 = {
...
const _hoisted_27 = { class: "selected-count" };
...
const _hoisted_34 = { class: "plan-resources" };
const _hoisted_35 = {
  key: 0,
  class: "plan-state"
};
...
const _hoisted_42 = { class: "safety-note" };
const _hoisted_43 = {
  key: 3,
...
const _hoisted_50 = { class: "modal compact-modal" };
const _hoisted_51 = {
  key: 0,
  class: "empty-state"
};
...
const _hoisted_53 = { class: "modal compact-modal" };
const _hoisted_54 = {
  key: 0,
  class: "empty-state"
};
  ...
  return (_openBlock(), _createElementBlock("main", _hoisted_1, [
    ...
    _createElementVNode("section", _hoisted_15, [
      _createElementVNode("div", _hoisted_16, [
        ...
        _cache[23] || (_cache[23] = _createElementVNode("span", null, "资源", -1)),
        _cache[24] || (_cache[24] = _createElementVNode("span", null, "媒体库", -1)),
        _cache[25] || (_cache[25] = _createElementVNode("span", null, "做种与保护", -1)),
        _cache[26] || (_cache[26] = _createElementVNode("span", null, "实际占用", -1)),
        _cache[27] || (_cache[27] = _createElementVNode("span", null, "完整删除影响", -1))
      ]),
      (loading.value)
        ? (_openBlock(), _createElementBlock("div", _hoisted_17, "正在读取真实资源关系…"))
        : (_openBlock(true), _createElementBlock(_Fragment, { key: 1 }, _renderList(visible.value, (item) => {
            return (_openBlock(), _createElementBlock("article", {
              ...
              }, _toDisplayString(item.protected ? '锁' : selected.value.includes(item.id) ? '✓' : ''), 11, _hoisted_18),
              ...
              _createElementVNode("div", _hoisted_20, [
                ...
                (item.episodeStatus === 'incomplete')
                  ? (_openBlock(), _createElementBlock("span", _hoisted_21, " 缺 " + _toDisplayString(item.episodeMissing) + " 集 · 已有 " + _toDisplayString(item.episodeActual) + " / 应有 " + _toDisplayString(item.episodeExpected), 1))
                  : _createCommentVNode("", true)
              ]),
      ...
      (!loading.value && !visible.value.length)
        ? (_openBlock(), _createElementBlock("div", _hoisted_25, " 没有符合条件的资源，请取消筛选或更换关键词。 "))
        : _createCommentVNode("", true)
    ]),
    (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
      (selected.value.length)
        ? (_openBlock(), _createElementBlock("aside", _hoisted_26, [
            _createElementVNode("div", _hoisted_27, _toDisplayString(selected.value.length), 1),
            _createElementVNode("p", null, [
              _cache[28] || (_cache[28] = _createElementVNode("strong", null, "已加入清理计划", -1)),
        ...
        ? (_openBlock(), _createElementBlock("div", {
            ...
            _createElementVNode("section", _hoisted_30, [
              _createElementVNode("header", null, [
                _createElementVNode("div", null, [
                  _cache[29] || (_cache[29] = _createElementVNode("span", null, "清理等级 · 真实预演", -1)),
              ...
              _createElementVNode("div", {
                ...
                (plan.value && planMode.value === 'delete')
                  ? (_openBlock(), _createElementBlock("strong", _hoisted_32, "已核算可释放 " + _toDisplayString(_unref(formatBytes)(plan.value.estimatedReclaimBytes)), 1))
                  : (_openBlock(), _createElementBlock("strong", _hoisted_33, _toDisplayString(currentAction.value?.detail), 1)),
              ...
              (planLoading.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_35, "正在刷新 NAS 状态并复核关系…"))
                : (planError.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_36, [
                      _cache[30] || (_cache[30] = _createElementVNode("strong", null, "无法生成计划", -1)),
                    ...
                    ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                        ...
                        (plan.value.requiresSiteAcknowledgement)
                          ? (_openBlock(), _createElementBlock("label", _hoisted_39, [
                              ...
                              _cache[31] || (_cache[31] = _createElementVNode("span", null, null, -1)),
                              _cache[32] || (_cache[32] = _createTextVNode(" 我已确认会影响私有站做种，并接受站点规则风险 ", -1))
                            ]))
                          : _createCommentVNode("", true),
                        (planExpired.value)
                          ? (_openBlock(), _createElementBlock("div", _hoisted_41, [...(_cache[33] || (_cache[33] = [
              ...
              _createElementVNode("div", _hoisted_42, [
                _cache[35] || (_cache[35] = _createElementVNode("i", null, "盾", -1)),
                _createElementVNode("p", null, [
                  _createElementVNode("strong", null, _toDisplayString(executionEnabled.value ? '执行前还需第二次确认' : '执行引擎未启用'), 1),
                  _cache[34] || (_cache[34] = _createElementVNode("span", null, "最终执行前复核当前清单，执行器只回读所选资源的 qB、路径和硬链接。", -1))
                ])
              ]),
              (executeResult.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_43, [
                    ...
                    (executeResult.value.snapshotRefreshPending)
                      ? (_openBlock(), _createElementBlock("span", _hoisted_44, _toDisplayString(planMode.value === 'delete' ? '已从当前列表移除，请刷新资源清单后继续操作。' : '操作已完成，请刷新资源清单后继续操作。'), 1))
                      : _createCommentVNode("", true),
                    _createElementVNode("button", {
                      type: "button",
                      onClick: closePlan
                ...
                : (finalConfirmation.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_45, [
                      _cache[36] || (_cache[36] = _createElementVNode("strong", null, "再次确认：系统将立即执行这份计划", -1)),
                      (executeError.value)
                        ? (_openBlock(), _createElementBlock("span", _hoisted_46, _toDisplayString(executeError.value), 1))
                        : _createCommentVNode("", true),
                      _createElementVNode("div", null, [
                        _createElementVNode("button", {
                          type: "button",
                        ...
                        _createElementVNode("button", {
                          ...
                          onClick: executePlan
                        }, _toDisplayString(executing.value ? '正在定向复核…' : `确认${currentAction.value?.title}`), 11, _hoisted_48)
                      ])
                    ]))
                  : (_openBlock(), _createElementBlock("button", {
                      key: 5,
      ...
      (gapOpen.value)
        ? (_openBlock(), _createElementBlock("div", {
            ...
            _createElementVNode("section", _hoisted_50, [
              ...
              (gapLoading.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_51, "正在核对…"))
                : _createCommentVNode("", true),
              (gapError.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_52, _toDisplayString(gapError.value), 1))
                : _createCommentVNode("", true),
        ...
        ? (_openBlock(), _createElementBlock("div", {
            ...
            _createElementVNode("section", _hoisted_53, [
              ...
              (recoveryLoading.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_54, "正在读取事务…"))
                : _createCommentVNode("", true),
              (recoveryError.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_55, _toDisplayString(recoveryError.value), 1))
                : _createCommentVNode("", true),
              ...
              (recoveryTarget.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_58, [
                    _createElementVNode("label", null, [
                      _cache[39] || (_cache[39] = _createTextVNode("输入确认短语 ", -1)),
                    ...
                    _createElementVNode("button", {
                      ...
                      onClick: runRecovery
                    }, _toDisplayString(recovering.value ? '处理中…' : '执行恢复'), 9, _hoisted_59)
                  ]))
                : _createCommentVNode("", true)
            ])
          ]))
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-a6386479"]]);
